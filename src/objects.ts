...
export function isCorrect(question: Question, answer: string): boolean {
    ...
    ); //https://www.geeksforgeeks.org/typescript/typescript-string-tolowercase-method/
}
...
export function isValid(question: Question, answer: string): boolean {
    if (question.type === "multiple_choice_question") {
        ...
        return true; //if it is anything else, inclyding short answer,it will be true
    }
}
...
export function publishQuestion(question: Question): Question {
    return { ...question, published: !question.published }; //if it was published, now it should be not published.
}
